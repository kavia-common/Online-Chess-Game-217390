...
import subprocess
import sys
import time  # kept for compatibility; may be used by older versions or extensions
...
# Legacy behavior: attempt to ensure pygame exists at runtime.
# We still keep this, but avoid bare `except` and keep imports ordered.
try:
    print("[GAME] Trying to import pygame")
except Exception:
    # This should never happen; print is extremely unlikely to fail.
    pass

try:
    # If pygame import fails in some environments, attempt install.
    # Note: pygame is already imported above for module usage; this block mainly
    # preserves original behavior/logging.
...
board = pygame.transform.scale(
    pygame.image.load(os.path.join("img", "board_alt.png")), (750, 750)
)
